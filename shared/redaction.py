...
def mask_email(email: str | None) -> str:
    """Maskiert eine E-Mail für Logs/Audit (#1177).

    Behält Domain + ersten Zeichen des local-parts, um Korrelation/Diagnose zu
    erlauben, ohne die volle (potenziell fremde) Adresse zu persistieren.
    Beispiel: ``john.doe@example.com`` → ``j***@example.com``.
    """
    s = (email or "").strip()
