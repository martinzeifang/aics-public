...
# ───────────────────────────────────────────────────────────────────────
# Server Public Key v1 — produziert auf 192.168.20.10:8444 am 2026-05-11
...
_DEFAULT_SERVER_URL = 'https://192.168.20.10:8444'
...
def save_settings(server_url: str, *, verify_tls: bool = False,
...
def get_client_config(
    *,
    ...
    if 'verify_tls' in file_settings:
        ...
        verify_tls = os.environ.get('AICS_LICENSE_VERIFY_TLS', '').strip().lower() in {'1', 'true', 'yes'}
