"""SOC-AI-Alarmanalyse — zweigleisig: lokales Ollama (Default) + Copy/Paste-Prompt.

Sensible Alarmdaten bleiben im Ollama-Default im Haus. Der Copy/Paste-Pfad
erzeugt denselben Prompt zum Einfügen in ChatGPT o.ä. und parst die JSON-Antwort.
"""
...
def _run_ollama(prompt: str) -> dict[str, Any]:
    return parse_analysis(_run_ollama_text(prompt))
