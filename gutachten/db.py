...
def _migrate_schema(con: sqlite3.Connection) -> None:
    ...
    if "unternehmen" not in cols:
        # Issue #427/#436: Kunden-Bezug fuer Reassign
        con.execute("ALTER TABLE gutachten_projects ADD COLUMN unternehmen TEXT NOT NULL DEFAULT ''")
