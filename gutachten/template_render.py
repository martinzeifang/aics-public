...
def _build_blocks(key: str, context: dict) -> list[tuple[str, tuple[str, ...]]]:
    ...
    def add_befunde(items):
        for b in items:
            ...
            # #972: Methode + Werkzeug je eigene Zeile, Label fett.
            if b.get("methode"):
    ...
    def add_beurteilungen(items):
        for u in items:
            ...
            # #973: Soll/Ist/Kausalität/Würdigung als Überschrift 3 + Text.
    ...
    if key == "befunde":
        ...
        if selbstchecks:
            ...
            if latest.get("beschreibung"):
                blocks.append((_strip_html(latest["beschreibung"]), BODY))
