...
def _build_blocks(key: str, context: dict) -> list[tuple[str, tuple[str, ...]]]:
    ...
    if key == "befunde":
        ...
        # Anhang (#1001) — H1 „Anhang" mit Asservaten + Glossar (jeweils H2),
        # respektiert include_anhang / include_glossar.
        assets = context.get("assets") or []
        glossar = context.get("glossar") or []
        want_anhang = bool(assets) and context.get("include_anhang", True)
