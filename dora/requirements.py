...
DORA_ANFORDERUNGEN: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        'beschreibung': 'Pläne für interne und externe Krisenkommunikation, einschließlich Aufsichtsbehörden, Kunden, Öffentlichkeit.',
    ...
    },
    {
        ...
        'beschreibung': 'Kriterien zur Klassifizierung schwerwiegender Vorfälle anhand von Schweregrad, Dauer, betroffenen Kunden, Reputation.',
    ...
    },
    {
        ...
        'pfeiler': 'ICT-IM',
        'ref': 'Art. 21',
        'titel': 'Reporting an Kunden und Geschäftspartner',
        'beschreibung': 'Information betroffener Kunden bei Vorfällen, die ihre Interessen tangieren.',
