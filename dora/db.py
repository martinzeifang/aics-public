    ...
    if existing:
        cur.execute("""
            ...
            SET unternehmen=?, finanzeinrichtung_klasse=?, beschreibung=?, berater=?,
                meta_json=?, updated_at=CURRENT_TIMESTAMP
            WHERE name=?
    ...
    *,
    ...
    con.execute("""
        ...
        ON CONFLICT(id) DO UPDATE SET
            ...
            meta_json=excluded.meta_json, updated_at=CURRENT_TIMESTAMP
    """, (
    ...
    *,
    ...
    con.execute("""
        ...
        ON CONFLICT(id) DO UPDATE SET
            ...
            ergebnis=excluded.ergebnis, updated_at=CURRENT_TIMESTAMP
    """, (
