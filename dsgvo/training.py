    ...
    "alle": [
        ...
        },
        {
            ...
            "inhalte": [
                ...
                "Soziale Medien: Keine Kundendaten oder interne Infos öffentlich teilen",
        ...
        },
        {
            ...
            "inhalte": [
                ...
                "Beschwerdemöglichkeiten für Mitarbeiter und Kunden",
            ],
    ...
    "management": [
        ...
        },
        {
            ...
            "inhalte": [
                ...
                "Datenschutz als Wettbewerbsvorteil: Vertrauen der Kunden stärken",
            ],
...
QUIZ_FRAGEN: dict[str, list[dict[str, Any]]] = {
    "alle": [
        ...
        {
            "frage": "Sie bemerken, dass ein Kollege versehentlich eine E-Mail mit Kundendaten an eine falsche Adresse geschickt hat. Was tun Sie?",
            "optionen": [
    ...
    "alle": [
        {
            ...
            "beschreibung": (
                "Ihr Kollege Max hat versehentlich eine Excel-Tabelle mit Kundenadressen "
                "an externe-kunden@example.com statt an internes-crm@ihrunternehmen.de gesendet."
            ),
    ...
    "it": [
        {
            ...
            "beschreibung": (
                ...
                "auf drei Servern. Kundendaten könnten abgeflossen sein."
            ),
    ...
    "management": [
        {
            ...
            "beschreibung": (
                ...
                "um alle Kundendaten zentral zu speichern."
            ),
            ...
            "loesung": [
                ...
                "Datenschutz-Folgenabschätzung (DSFA) prüfen: hohes Risiko durch zentralisierte Kundendaten?",
