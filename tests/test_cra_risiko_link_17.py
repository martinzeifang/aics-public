...
Bidirektionale meta-Verknüpfung, Link-Kandidaten nach Firma, Risiko-Summary.
"""
...
def projekte(client, auth_headers):
    # CRA-Projekt + RB-Projekt mit gleichem Firmen
