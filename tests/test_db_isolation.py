...
class TestDbManager:
    ...
    def test_transaction_commit(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Nach transaction() ist die Session geschlossen → keine offene Transaktion
            # (SQLAlchemy 2.x: is_active != "hat offene Transaktion"; in_transaction() nutzen)
    ...
    def test_transaction_rollback_on_exception(self):
        ...
        # Session geschlossen (auch bei Exception) → keine offene Transaktion
        assert session.in_transaction() is False
