  ...
  <div class="kunden-sidebar">
    ...
    <div v-else class="sidebar-list">
      ...
      >
        ...
        <!-- Wenn Projekt-Name != Kunde, zeigen wir den Projekt-Namen als Sub-Zeile.
             Das passiert bei Altdaten oder wenn manuell mehrere Projekte je Kunde
      ...
      <div v-if="projektListe.length === 0" class="sidebar-empty">
        ...
        <p class="hint-text">
          {{ moduleLabel }} ist <strong>kundenbezogen</strong> — pro Kunde
          eine Bewertung. Lege einen Kunden mit aktiviertem
          {{ moduleLabel }}-Modul in der Kundenverwaltung an.
        </p>
    ...
    <div v-if="projektListe.length > 0" class="sidebar-footer">
      <small class="hint-text">
        Neuer Kunde? Lege ihn in der <router-link to="/kunden">Kundenverwaltung</router-link>
...
// Sort: Kunde (unternehmen) alphabetisch, ohne-Kunde nach hinten
