...
const autoResult = ref<{ open: boolean; streaming: boolean; bewertung: number | null; kommentar: string; massnahme: string; provider: string; data: any }>(
  { open: false, streaming: false, bewertung: null, kommentar: '', massnahme: '', provider: '', data: null })
