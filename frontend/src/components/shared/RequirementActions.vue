...
{{ jsonModal.preview.massnahme || '' }}</pre>
    ...
    <!-- Issue erstellen -->
    <div v-if="createModal.open" class="modal-overlay nested" @click.self="createModal.open = false">
      <div class="modal-content prompt-modal">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div v-if="createModal.created" class="preview">
            ✅ <a :href="createModal.created.url" target="_blank">{{ createModal.created.url }}</a>
          </div>
        </div>
        <div class="modal-footer">
    ...
    <!-- Issue verknüpfen -->
    <div v-if="linkModal.open" class="modal-overlay nested" @click.self="linkModal.open = false">
      <div class="modal-content prompt-modal">
        <div class="modal-header">
