  ...
  <div class="pflicht-doku">
    ...
    <details class="section">
      ...
      <div class="section-body">
        ...
        <div class="wizard-launch">
          <button class="btn-primary" @click="openSimpleWizard('ho')">🤖 Wizard</button>
          <span class="hint">Erstellt einen Vorschlag für Oversight-Modus + Intervention-Mechanismen.</span>
        </div>
        <div class="form-grid">
    ...
    <details class="section">
      ...
      <div class="section-body">
        ...
        <div class="wizard-launch">
          <button class="btn-primary" @click="openSimpleWizard('pmm')">🤖 Monitoring-Plan-Wizard</button>
          <span class="hint">Erstellt einen Vorschlag für Monitoring-Plan, Drift-Detection und Incident-SLA.</span>
        </div>
...
const openSimpleWizard = async (kind: SimpleWizardKind) => {
  simpleWizard.value = { open: true, kind, title: SIMPLE_WIZARD_TITLES[kind],
                         prompt: '', response: '', busy: true, result: null, error: '' }
  let prompt = ''
