<template>
  <div class="rb-view">
    <div class="header">
      ...
      <ModuleHelpButton module="risikobewertung" class="header-help" />
    </div>
    ...
    <template v-else-if="rb.selectedProjektObj">
      ...
      <details class="repo-config-section">
        <summary>🔗 Repository für Issue-Anbindung (pro Projekt)</summary>
        <RepoConfigPanel
