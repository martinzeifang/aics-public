<template>
  ...
  >
    ...
    <template v-if="rb.selectedProjektObj">
      <!-- Tab: Dashboard -->
      <!-- #1501: bewusst KEIN geteiltes ModuleDashboard. Die Risikobewertung ist die
           Risiko-QUELLE selbst (Risikomatrix, Framework, Einzelrisiken) — nicht ein
           Reifegrad-/Bereiche-/Dokumente-Modul wie CRA/NIS2/AI-Act/DSGVO/WiBA. Das
           generische Schema (Reifegrad-Gauge + Bereichskarten + Dokumente-Soll-Ist)
           passt fachlich nicht; daher eigenes, risikozentrisches Dashboard. -->
...
// RB-Projekte fuer diese Firma zaehlen + Name-Vorschlag generieren.
