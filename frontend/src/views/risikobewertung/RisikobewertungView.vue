  ...
  <div class="rb-view">
    ...
    <template v-else-if="rb.selectedProjektObj">
      ...
      <div class="toolbar">
        ...
        <button class="btn-secondary" @click="syncIssues" :disabled="issuesBusy" title="Status aller verlinkten Issues dieses Projekts von GitHub/GitLab aktualisieren">🔄 Issues synchronisieren</button>
