<template>
  <div class="modal-overlay" @click.self="onCancel">
    ...
    <div v-if="promptModal.open" class="modal-overlay nested" @click.self="promptModal.open = false">
    ...
    <div v-if="jsonModal.open" class="modal-overlay nested" @click.self="jsonModal.open = false">
      <div class="modal-content prompt-modal">
        <div class="modal-header">
    ...
    <!-- Issue-Import-Modal -->
    <div v-if="issueModal.open" class="modal-overlay nested" @click.self="issueModal.open = false">
      <div class="modal-content prompt-modal">
        <div class="modal-header">
    ...
    <!-- Re-Assessment-Modal -->
    <div v-if="reAssessmentModal.open" class="modal-overlay nested" @click.self="reAssessmentModal.open = false">
    ...
    <!-- Ollama-Live-Modal -->
    <div v-if="ollamaModal.open" class="modal-overlay nested" @click.self="ollamaModal.done && (ollamaModal.open = false)">
