<template>
  <div class="gutachten-view">
    ...
    <div v-if="konvertOpen" class="modal-overlay" @click.self="closeKonvert">
      <div class="modal-content modal-wide">
        <div class="modal-header">
...
const goToPg = () => {
  // Wechsel in Gerichtsgutachten-View (über Router) — vereinfacht: schließen + Hinweis
  closeKonvert()
  // Wenn Router-Link verfügbar:
  if (konvertResult.value?.pg_name) {
    window.location.hash = `#/gutachten/gerichts?projekt=${encodeURIComponent(konvertResult.value.pg_name)}`
  }
}
