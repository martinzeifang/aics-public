<template>
  <div class="dsgvo-view">
    ...
    <div v-if="activeTab === 'pflichtdoku'">
      <DSGVOPflichtDokuPanel @open-assistenten="activeTab = 'assistenten'" />
    </div>
    ...
    <template v-if="activeTab === 'assistenten'">
      ...
      <AssistentenKachelGrid :wizards="dsgvoWizards" grouped @open="onAssistentOpen" />
    </template>
...
type DsgvoTab = 'pflichtdoku' | 'anforderungen' | 'assistenten' | 'tom' | 'privacy' | 'training' | 'cockpit'
const activeTab = ref<DsgvoTab>('pflichtdoku')
