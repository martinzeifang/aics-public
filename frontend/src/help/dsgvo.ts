...
export const dsgvoHelp: ModuleHelp = {
  ...
  "areas": [
    ...
    },
    {
      "id": "dsms-cockpit",
      "title": "📊 DSMS-Cockpit",
      "zweck": "Read-only-Gesamtüberblick über den Reifegrad aller DSMS-Bereiche und offene Fristen – Steuerungs- und Nachweisinstrument für die Rechenschaftspflicht.",
