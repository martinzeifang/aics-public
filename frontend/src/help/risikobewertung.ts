...
export const risikobewertungHelp: ModuleHelp = {
  ...
  "legalBasis": {
    ...
    "bullets": [
      ...
      "Branchenspezifisch fuer Finanzinstitute: IT-Risikoanforderungen aus BAIT/VAIT, MaRisk und EBA-Leitlinien zur IKT- und Sicherheitsrisikosteuerung."
    ]
  },
  "implementation": {
  ...
  "frameworks": [
    ...
    },
    {
      ...
      "ref": "BAIT/VAIT, MaRisk, EBA-Leitlinien zur IKT-Sicherheit",
