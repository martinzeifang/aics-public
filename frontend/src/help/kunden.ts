...
export const kundenHelp: ModuleHelp = {
  "title": "Kunden",
  ...
  "implementation": {
    ...
    "intro": "Empfohlener Arbeitsablauf: zuerst die Stammdaten anlegen (Kunde, dann Produkt), anschließend pro Produkt je benötigtem Compliance-Rahmen ein Projekt erzeugen und dieses dann im jeweiligen Fachmodul (CRA, NIS2, KI-VO, DSGVO, Risikobewertung) bearbeiten. Das Modul Kunden bleibt die Übersicht; die inhaltliche Arbeit findet in den Modul-Projekten statt.",
    "bullets": [
      "Schritt 1: Kunde anlegen (Organisation/Mandant) mit eindeutiger Bezeichnung.",
      "Schritt 2: Produkt(e) je Kunde erfassen – ein Produkt = eine Bewertungseinheit (z. B. ein Software-/KI-Produkt oder Dienst).",
  ...
  "moduleSpecific": {
    ...
    "intro": "Kunden ist ein Workflow- und Stammdatenmodul ohne eigene Fragebogen-/Bewertungslogik. Seine Aufgabe ist die mandantenfähige Strukturierung, aus der die fachlichen Projekte hervorgehen.",
    "bullets": [
      "Hierarchie: Kunde → Produkt → Projekt je Compliance-Rahmen (1 Produkt kann mehrere Rahmen-Projekte haben).",
      "Mandantenfähigkeit: Daten sind je Kunde getrennt; dies trennt auch Verantwortlichkeiten und Nachweise sauber.",
