...
def _connect(db_path: Path) -> sqlite3.Connection:
    ...
    try:
        con.execute("ALTER TABLE rb_projekte ADD COLUMN meta_json TEXT NOT NULL DEFAULT '{}' ")
...
def save_projekt(
    ...
    *,
    ...
    con.execute(
        """INSERT INTO rb_projekte(name, framework, beschreibung, meta_json, updated_at)
           VALUES(?,?,?,?,datetime('now'))
        ...
        (name, framework, beschreibung, json.dumps(meta or {}, ensure_ascii=False)),
    )
    con.commit()
