...
| Befund | Beleg |
|---|---|
| 13 SQLite-DBs: users, cra, risikobewertung, gutachten, baso, dsgvo, nis2, ai_act, evidence, kunden, dora, ict, compliance | `*/db.py` + `server/auth/users_db.py` |
...
| #906 | Kunden (`kunden/db.py`) | L | Mittel |
