...
def _connect(db_path: Path = DEFAULT_DB_PATH) -> sqlite3.Connection:
    ...
    # Mehrere gunicorn-Worker rufen ensure_db() beim Boot gleichzeitig auf →
    # ohne busy_timeout schlägt ein paralleler Schreibzugriff sofort mit
    # "database is locked" fehl. 30s warten statt crashen.
