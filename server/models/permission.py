...
class RoleEnum(str, Enum):
    ...
    SOC_OPERATOR = "soc_operator"  # SOC-Analyst:in — Wazuh-Alarm-Triage + Incidents (#1257)
...
class Permission(str, Enum):
    ...
    CRA_APPROVE = "cra:approve"   # #1220-A — Konformitäts-/Bewertungs-Sign-off (Governance)
    ...
    # SOC (Security Operations Center — Wazuh-Alarm-Triage & Incidents, #1257)
    SOC_READ = "soc:read"
    SOC_WRITE = "soc:write"
    SOC_TRIAGE = "soc:triage"       # Alarm-Status/Triage bearbeiten
    SOC_INCIDENT = "soc:incident"   # Incidents anlegen/führen + Meldetracks
    SOC_CONFIG = "soc:config"       # Wazuh-Verbindung/Einrichtung (Admin-nah)
    SOC_EXPORT = "soc:export"
...
MODULE_PERMISSIONS: dict[str, list[Permission]] = {
    ...
    'cra': [Permission.CRA_READ, Permission.CRA_WRITE, Permission.CRA_PREFILL,
            Permission.CRA_ISSUE_LINK, Permission.CRA_EXPORT, Permission.CRA_APPROVE],
    ...
    'soc': [Permission.SOC_READ, Permission.SOC_WRITE, Permission.SOC_TRIAGE,
...
ROLE_PERMISSIONS: dict[RoleEnum, list[Permission]] = {
    ...
    # Operator: SOC-Analyst:in (Triage + Incidents, ohne Verbindungs-Setup-Zwang —
    # SOC_CONFIG ist enthalten, kann per Rollen-Feintuning entzogen werden)
    RoleEnum.SOC_OPERATOR: MODULE_PERMISSIONS['soc'],
}
